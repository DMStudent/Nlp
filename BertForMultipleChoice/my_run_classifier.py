  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      logging_hook = tf.train.LoggingTensorHook({
          "loss": total_loss, "probabilities":probabilities[:5], "labels":labels[:5],
            "one_hot_labels":one_hot_labels[:5], "log_probs":log_probs[:5],
            "per_example_loss":per_example_loss[:5]}, every_n_iter=50)
